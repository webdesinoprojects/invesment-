  ...
  return (
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-[#f4f7f5] px-5 py-12 text-slate-950">
      ...
      <section className="relative w-full max-w-md rounded-[28px] border border-white bg-white/90 p-8 shadow-[0_30px_90px_rgba(15,23,42,.14)] backdrop-blur md:p-10">
        <div className="flex items-center justify-between"><div className="flex items-center gap-3"><span className="grid size-11 place-items-center rounded-2xl bg-emerald-500 text-slate-950"><Activity className="size-6" /></span><div><p className="font-bold">NaturePower</p><p className="text-xs text-slate-500">Administration</p></div></div><ShieldCheck className="size-7 text-emerald-600" /></div>
