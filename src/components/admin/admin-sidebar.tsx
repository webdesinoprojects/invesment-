...
const items = [
  ...
  { label: "Investments", icon: ChartNoAxesCombined, permission: "investments.view", children: [["All Investments","/admin/investments","investments.view"],["Credit Investment","/admin/investments/activate","investments.manual"]] },
  ...
  { label: "Platform Revenue", href: "/admin/platform-revenue", icon: ReceiptText, permission: "income.view" },
