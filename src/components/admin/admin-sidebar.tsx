...
const items = [
  ...
  { label: "Members", icon: Users, permission: "members.view", children: [["All Members","/admin/members"],["Pending Members","/admin/members/pending"],["Blocked Members","/admin/members/blocked"]] },
  { label: "Deposits", icon: CreditCard, permission: "deposits.view", children: [["Pending Deposits","/admin/deposits/pending"],["Deposit History","/admin/deposits/history"]] },
  { label: "Withdrawals", icon: Landmark, permission: "withdrawals.view", children: [["Pending Withdrawals","/admin/withdrawals/pending"],["Processing","/admin/withdrawals/processing"],["Withdrawal History","/admin/withdrawals/history"]] },
  { label: "Investments", icon: ChartNoAxesCombined, permission: "investments.view", children: [["All Investments","/admin/investments"],["Manual Activation","/admin/investments/activate"]] },
  { label: "ROI Management", icon: CircleDollarSign, permission: "roi.view", children: [["ROI Runs","/admin/roi/runs"],["Run History","/admin/roi/history"]] },
  { label: "Referral Network", icon: Network, permission: "referrals.view", children: [["Referral Tree","/admin/referrals/tree"],["Team Analytics","/admin/referrals/analytics"]] },
  ...
  { label: "Admin Management", icon: ShieldCheck, permission: "administrators.view", children: [["Administrators","/admin/administrators"],["Roles & Permissions","/admin/roles"]] },
