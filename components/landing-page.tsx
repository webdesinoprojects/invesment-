...
function Header() {
  ...
  return (
    <header className={scrolled ? "header scrolled" : "header"}>
      ...
      <Button className="desktop-cta" onClick={() => scrollTo("contact")}>Get Started</Button>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            <Button onClick={() => { scrollTo("contact"); setOpen(false); }}>Get Started</Button>
          </motion.nav>
        )}
      </AnimatePresence>
    </header>
      ...
      <section id="packages" className="content-section packages-section">
        <div className="container">
          ...
          <Reveal className="plan-card">
            ...
            <Button variant="gold" onClick={() => scrollTo("contact")}>Invest Now <ArrowRight size={18} /></Button>
          </Reveal>
        </div>
      </section>
